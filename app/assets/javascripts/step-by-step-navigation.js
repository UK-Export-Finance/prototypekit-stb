...
(function (Modules) {
  ...
  AppStepNav.prototype.init = function () {
    ...
    this.$module.stepHeaders =
      this.$module.querySelectorAll(".js-toggle-panel");
    ...
    var stepNavTracker = new this.StepNavTracker(
    ...
    for (var i = 0; i < this.$module.stepHeaders.length; i++) {
      ...
      if (!thisel.querySelectorAll(".js-toggle-link").length) {
        ...
        showHideSpanIcon.className =
          "app-step-nav__chevron js-toggle-link-icon";
    ...
    for (var i = 0; i < jsLinks.length; i++) {
      jsLinks[i].addEventListener("click", function (event) {
        ...
        if (this.getAttribute("rel") !== "external") {
          that.saveToSessionStorage(
            that.$module.sessionStoreLink,
            dataPosition
          );
        }
  ...
  AppStepNav.prototype.removeActiveStateFromAllButCurrent = function (
    activeLinks,
    current
  ) {
  ...
  AppStepNav.prototype.bindToggleShowHideAllButton = function (stepNavTracker) {
    ...
    this.$module.showOrHideAllButton.addEventListener(
      "click",
      function (event) {
        ...
        stepNavTracker.trackClick(
          "pageElementInteraction",
          shouldShowAll ? "stepNavAllShown" : "stepNavAllHidden",
          {
            label:
              (shouldShowAll
                ? that.$module.actions.showAllText
                : that.$module.actions.hideAllText) +
              ": " +
              that.$module.stepNavSize,
          }
        );
  ...
  AppStepNav.prototype.StepView = function (stepElement, $module) {
    ...
    var textElement = this.stepElement.querySelectorAll(
      ".js-step-title-text"
    )[0];
  ...
  AppStepNav.prototype.StepToggleClick = function (
    event,
    stepView,
    stepNavTracker,
    stepIsOptional,
  ...
  AppStepNav.prototype.ComponentLinkClick = function (
    event,
    stepNavTracker,
    linkPosition,
    size
  ...
  AppStepNav.prototype.StepNavTracker = function (
    uniqueId,
    totalSteps,
    totalLinks
  ) {
