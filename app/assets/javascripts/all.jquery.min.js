!(function (e, t) {
  ...
  !(function (e, t) {
            ...
            if (null != (e = arguments[a]))
              for (t in e)
                (n = e[t]),
                  "__proto__" !== t &&
                    i !== n &&
                    (u && n && (C.isPlainObject(n) || (o = Array.isArray(n)))
                      ? ((r = i[t]),
                        (r =
                          o && !Array.isArray(r)
                            ? []
        ...
        function _(e, t, n, o) {
          ...
          if (!o && (T(t), (t = t || k), C)) {
            ...
            if (
              ...
              if (((l = e), (c = t), 1 === d && (te.test(e) || ee.test(e)))) {
                for (
                  ((c = (ue.test(e) && ge(t.parentNode)) || t) === t &&
                    f.scope) ||
                    ((a = t.getAttribute("id"))
                      ? (a = a.replace(le, ce))
        ...
        function L(a) {
          return N(function (i) {
            return (
              (i = +i),
              N(function (e, t) {
                for (var n, o = a([], e.length, i), r = o.length; r--; )
                  e[(n = o[r])] && (e[n] = !(t[n] = e[n]));
              })
            );
          });
            ...
            return (
              e != k &&
                ...
                c != k &&
                  ...
                  e.top !== e &&
                  (e.addEventListener
                    ? e.addEventListener("unload", de, !1)
                    : e.attachEvent && e.attachEvent("onunload", de)),
                (f.scope = M(function (e) {
                  return (
                ...
                (f.attributes = M(function (e) {
                  return (e.className = "i"), !e.getAttribute("className");
                })),
                (f.getElementsByTagName = M(function (e) {
                  return (
                    e.appendChild(k.createComment("")),
                    !e.getElementsByTagName("*").length
                  );
                })),
                (f.getElementsByClassName = p.test(k.getElementsByClassName)),
                (f.getById = M(function (e) {
                  return (
                    (n.appendChild(e).id = j),
                    !k.getElementsByName || !k.getElementsByName(j).length
                  );
                })),
                f.getById
                ...
                (o = []),
                (m = []),
                (f.qsa = p.test(k.querySelectorAll)) &&
                  (M(function (e) {
                    var t;
                  ...
                  ? function (e, t) {
                      ...
                      return (
                        ...
                        (!f.sortDetached && t.compareDocumentPosition(e) === n)
                          ? e == k || (e.ownerDocument == c && g(c, e))
                            ? -1
                            : t == k || (t.ownerDocument == c && g(c, t))
                            ? 1
                            : u
                            ? E(u, e) - E(u, t)
                            : 0
        ...
        ((x = _.selectors =
          {
            ...
            filter: {
              TAG: function (e) {
                var t = e.replace(v, b).toLowerCase();
                return "*" === e
                  ? function () {
                      return !0;
                    }
                ...
                return a[j]
                  ...
                  ? ((t = [e, e, "", i]),
                    x.setFilters.hasOwnProperty(e.toLowerCase())
                      ? N(function (e, t) {
                          for (var n, o = a(e, i), r = o.length; r--; )
                            e[(n = E(e, o[r]))] = !(t[n] = o[r]);
                        })
                      : function (e) {
                          return a(e, 0, t);
            ...
            pseudos: {
              not: N(function (e) {
                ...
                return s[j]
                  ? N(function (e, t, n, o) {
                      for (var r, i = s(e, null, o, []), a = e.length; a--; )
                        (r = i[a]) && (e[a] = !(t[a] = r));
                    })
                  : function (e, t, n) {
                      return (
                        (o[0] = e), s(o, null, n, r), (o[0] = null), !r.pop()
                      );
                    };
              }),
              has: N(function (t) {
              ...
              lang: N(function (n) {
                return (
                  oe.test(n || "") || _.error("unsupported lang: " + n),
                  (n = n.replace(v, b).toLowerCase()),
                  function (e) {
                    var t;
                    do {
                      if (
                ...
                if (n) {
                  ...
                  for (; (e = e[s]); )
                    if (1 === e.nodeType || c)
                      if (
                        ((r =
                          (r = e[j] || (e[j] = {}))[e.uniqueID] ||
                          (r[e.uniqueID] = {})),
                        u && u === e.nodeName.toLowerCase())
                      )
                        e = e[s] || e;
                      else {
                        if ((o = r[l]) && o[0] === S && o[1] === d)
                          return (i[2] = o[2]);
            ...
            N(function (e, t, n, o) {
              var r,
                ...
                c =
                  e ||
                  (function (e, t, n) {
                    for (var o = 0, r = t.length; o < r; o++) _(e, t[o], n);
                    return n;
                  })(h || "*", n.nodeType ? [n] : n, []),
                d = !f || (!e && h) ? c : we(c, s, f, n, o),
                p = m ? (y || (e ? f : l || g) ? [] : t) : d;
              if ((m && m(d, p, n, o), g))
                for (r = we(p, u), g(r, [], n, o), i = r.length; i--; )
                  (a = r[i]) && (p[u[i]] = !(d[u[i]] = a));
              if (e) {
                if (y || f) {
                  if (y) {
              ...
              } else (p = we(p === t ? p.splice(l, p.length) : p)), y ? y(null, t, p, o) : A.apply(t, p);
            })
          );
        }
        return (
          ...
          (h = _.tokenize =
            function (e, t) {
              ...
              return t ? a.length : a ? _.error(e) : W(e, s).slice(0);
            }),
          (R = _.compile =
            function (e, t) {
              var n,
                ...
                for (n = (t = t || h(e)).length; n--; )
                  ((a = (function d(e) {
                    for (
                      ...
                      if ((t = x.relative[e[s].type])) c = [be(xe(c), t)];
                      else {
                        if (
                          (t = x.filter[e[s].type].apply(null, e[s].matches))[j]
                        ) {
                ...
                (a = $(
                  ...
                  (o = function (e, t, n, o, r) {
                    ...
                    for (
                      ...
                      if (b && i) {
                        for (
                          a = 0, t || i.ownerDocument == k || (T(i), (n = !C));
                          (s = g[a++]);
            ...
            function (e, t, n, o) {
              ...
              if (((n = n || []), 1 === c.length)) {
                if (
                  ...
                  if (
                    !(t = (x.find.ID(a.matches[0].replace(v, b), t) || [])[0])
                  )
                    return n;
                  l && (t = t.parentNode),
                ...
                for (
                  r = d.needsContext.test(e) ? 0 : i.length;
                  ...
                  if (
                    (u = x.find[s]) &&
                    (o = u(
                      a.matches[0].replace(v, b),
                      (ue.test(i[0].type) && ge(t.parentNode)) || t
                    ))
                  ) {
                    if ((i.splice(r, 1), (e = o.length && ve(i)))) break;
          ...
          (f.sortStable = j.split("").sort(z).join("") === j),
          (f.detectDuplicates = !!l),
          T(),
          (f.sortDetached = M(function (e) {
      ...
      C.fn.extend({
        find: function (e) {
          ...
          if ("string" != typeof e)
            return this.pushStack(
              C(e).filter(function () {
                for (t = 0; t < o; t++) if (C.contains(r[t], this)) return !0;
              })
            );
          for (n = this.pushStack([]), t = 0; t < o; t++) C.find(e, r[t], n);
        ...
        (((C.fn.init = function (e, t, n) {
          ...
          if (o[1]) {
            if (
              ...
              Y.test(o[1]) && C.isPlainObject(t))
            )
              for (var o in t) v(this[o]) ? this[o](t[o]) : this.attr(o, t[o]);
            return this;
          }
          return (
            (n = k.getElementById(o[2])) && ((this[0] = n), (this.length = 1)),
            this
          );
        }).prototype = C.fn),
        (Z = C(k)),
          ...
          C.fn[o] = function (e, t) {
            ...
            return (
              (t = "Until" !== o.slice(-5) ? e : t) &&
                ...
                (n = C.filter(t, n)),
              1 < this.length &&
                (ne[o] || C.uniqueSort(n), te.test(o) && n.reverse()),
              this.pushStack(n)
            );
          };
        }
    ...
    (C.Callbacks = function (o) {
      ...
      var r,
        ...
        l = -1,
        c = function () {
          for (a = a || o.once, i = r = !0; u.length; l = -1)
            for (t = u.shift(); ++l < s.length; )
              !1 === s[l].apply(t[0], t[1]) &&
                o.stopOnFalse &&
                ((l = s.length), (t = !1));
          o.memory || (t = !1), (r = !1), a && (s = t ? [] : "");
        },
        d = {
          add: function () {
            return (
      ...
      C.extend({
                      ...
                      t = function () {
                        ...
                        if (!(i < l)) {
                          ...
                          (t =
                            ...
                            v(t)
                              ? u
                                ? t.call(e, c(l, a, d, u), c(l, a, re, u))
                                : (l++,
                                  t.call(
                                    e,
                                    c(l, a, d, u),
                                    c(l, a, re, u),
                                    c(l, a, d, a.notifyWith)
                                  ))
                              : (s !== d && ((n = undefined), (o = [e])),
                                (u || a.resolveWith)(n, o));
                        }
                        ...
                        : function () {
                            try {
                              ...
                              C.Deferred.exceptionHook &&
                                C.Deferred.exceptionHook(e, r.stackTrace),
                                l <= i + 1 &&
                                  (s !== re && ((n = undefined), (o = [e])),
                                  a.rejectWith(n, o));
                            }
                          };
                    i
                      ...
                      : (C.Deferred.getStackHook &&
                          (r.stackTrace = C.Deferred.getStackHook()),
                        T.setTimeout(r));
                  };
                }
                return C.Deferred(function (e) {
                  i[0][3].add(c(0, e, v(o) ? o : d, e.notifyWith)),
                    i[1][3].add(c(0, e, v(t) ? t : d)),
                    i[2][3].add(c(0, e, v(n) ? n : re));
                }).promise();
              },
              promise: function (e) {
        ...
        when: function (e) {
          ...
          if (
            n <= 1 &&
            (ie(e, i.done(a(t)).resolve, i.reject, !n),
            "pending" === i.state() || v(r[t] && r[t].then))
          )
            return i.then();
          for (; t--; ) ie(r[t], a(t), i.reject);
          return i.promise();
        },
      });
    ...
    var c = function (e, t, n, o, r, i, a) {
        var s = 0,
          u = e.length,
          l = null == n;
        if ("object" === h(n))
          for (s in ((r = !0), n)) c(e, t, s, n[s], !0, i, a);
        else if (
          o !== undefined &&
          ((r = !0),
          v(o) || (a = !0),
        ...
        return r ? e : l ? t.call(e) : u ? t(e[0], n) : i;
      },
      le = /^-ms-/,
      ce = /-([a-z])/g;
    function de(e, t) {
    ...
    (pe.uid = 1),
      (pe.prototype = {
        ...
        hasData: function (e) {
          e = e[this.expando];
          return e !== undefined && !C.isEmptyObject(e);
        },
      });
    var x = new pe(),
      l = new pe(),
    ...
    function me(e, t, n) {
      ...
      if (n === undefined && 1 === e.nodeType)
        if (
          ((o = "data-" + t.replace(he, "-$&").toLowerCase()),
    ...
    C.extend({
      ...
      C.fn.extend({
        data: function (n, e) {
          ...
          if (
            this.length &&
            ((r = l.get(i)), 1 === i.nodeType && !x.get(i, "hasDataAttrs"))
          ) {
            for (t = a.length; t--; )
              a[t] &&
                0 === (o = a[t].name).indexOf("data-") &&
                ((o = b(o.slice(5))), me(i, o, r[o]));
      ...
      C.extend({
        queue: function (e, t, n) {
          ...
          if (e)
            return (
              (o = x.get(e, (t = (t || "fx") + "queue"))),
              n &&
                (!o || Array.isArray(n)
                  ? (o = x.access(e, t, C.makeArray(n)))
                  : o.push(n)),
              o || []
            );
        },
      ...
      ve =
        ...
        function (e, t) {
          return (
            ...
            ("" === e.style.display && S(e) && "none" === C.css(e, "display"))
          );
        });
    function be(e, t, n, o) {
      var r,
    ...
    var xe = {};
    function A(e, t) {
      for (var n, o, r, i, a, s = [], u = 0, l = e.length; u < l; u++)
        (o = e[u]).style &&
          ((n = o.style.display),
          t
            ? ("none" === n &&
                ((s[u] = x.get(o, "display") || null),
                s[u] || (o.style.display = "")),
              "" === o.style.display &&
                ve(o) &&
                (s[u] =
                  ...
                  (a = xe[r]) ||
                    ...
                    (xe[r] = a = "none" === a ? "block" : a)))))
            : "none" !== n && ((s[u] = "none"), x.set(o, "display", n)));
    ...
    function B(e, t) {
      var n =
        "undefined" != typeof e.getElementsByTagName
          ...
          : [];
      return t === undefined || (t && u(e, t)) ? C.merge([e], n) : n;
    }
    function Ce(e, t) {
    ...
    function Se(e, t, n, o, r) {
      for (
        ...
        if ((i = e[p]) || 0 === i)
          if ("object" === h(i)) C.merge(d, i.nodeType ? [i] : i);
          else if (je.test(i)) {
            for (
      ...
      for (c.textContent = "", p = 0; (i = d[p++]); )
        if (o && -1 < C.inArray(i, o)) r && r.push(i);
        else if (
          ((u = S(i)), (a = B(c.appendChild(i), "script")), u && Ce(a), n)
        )
    ...
    function Be(e, t, n, o, r, i) {
      var a, s;
      if ("object" == typeof t) {
        for (s in ("string" != typeof n && ((o = o || n), (n = undefined)), t))
          Be(e, s, n, o, t[s], i);
        return e;
      }
      if (
    ...
    function _e(e, r, i) {
      i
        ...
        : x.get(e, r) === undefined && C.event.add(e, r, n);
    }
    (C.event = {
      global: {},
            ...
            (d = f = (p = Ae.exec(e[u]) || [])[1]),
              ...
              d &&
                ...
                (c = s[d]) ||
                  ...
                  (l.setup && !1 !== l.setup.call(t, o, p, a)) ||
                    (t.addEventListener && t.addEventListener(d, a))),
                l.add &&
                  (l.add.call(t, f),
                  f.handler.guid || (f.handler.guid = n.guid)),
                r ? c.splice(c.delegateCount++, 0, f) : c.push(f),
                (C.event.global[d] = !0));
      },
          ...
          for (l = (t = (t || "").match(j) || [""]).length; l--; )
            if (
              ...
              a &&
                ...
                delete u[f]);
            } else for (f in u) C.event.remove(e, f + t[l], n, o, !0);
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            i = C.event.handlers.call(this, s, e), t = 0;
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            e = this || e;
            return (
              we.test(e.type) && e.click && u(e, "input") && _e(e, "click", n),
              !1
            );
          },
          trigger: function (e) {
            e = this || e;
            return (
              we.test(e.type) && e.click && u(e, "input") && _e(e, "click"), !0
            );
          },
          _default: function (e) {
            e = e.target;
    ...
    function He(e, t) {
      ...
      if (1 === t.nodeType) {
        if (x.hasData(e) && (i = x.get(e).events))
          for (r in (x.remove(t, "handle events"), i))
            for (n = 0, o = i[r].length; n < o; n++) C.event.add(t, r, i[r][n]);
    ...
    function _(n, o, r, i) {
      ...
      var e,
        ...
        f = o[0],
        h = v(f);
      if (h || (1 < d && "string" == typeof f && !m.checkClone && Ne.test(f)))
        return n.each(function (e) {
          var t = n.eq(e);
          h && (o[0] = f.call(this, e, t.html())), _(t, o, r, i);
        });
      if (
        d &&
        ((t = (e = Se(o, n[0].ownerDocument, !1, n, i)).firstChild),
        1 === e.childNodes.length && (e = t),
        t || i)
      ) {
        for (s = (a = C.map(B(e, "script"), qe)).length; c < d; c++)
          (u = e),
            c !== p &&
              ((u = C.clone(u, !0, !0)), s && C.merge(a, B(u, "script"))),
            r.call(n[c], u, c);
        if (s)
          for (
            l = a[a.length - 1].ownerDocument, C.map(a, Fe), c = 0;
            c < s;
            c++
          )
            (u = a[c]),
              ke.test(u.type || "") &&
                ...
                (u.src && "module" !== (u.type || "").toLowerCase()
                  ...
                  : X(u.textContent.replace(Me, ""), u, l));
      }
      return n;
    }
    function Re(e, t, n) {
      for (var o, r = t ? C.filter(t, e) : e, i = 0; null != (o = r[i]); i++)
        n || 1 !== o.nodeType || C.cleanData(B(o)),
          o.parentNode &&
            (n && S(o) && Ce(B(o, "script")), o.parentNode.removeChild(o));
      return e;
    }
    C.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (a = B(c), o = 0, r = (i = B(e)).length; o < r; o++)
            (s = i[o]),
              (u = a[o]),
              (l = void 0),
        ...
        if (t)
          if (n)
            for (i = i || B(e), a = a || B(c), o = 0, r = i.length; o < r; o++)
              He(i[o], a[o]);
          else He(e, c);
        return (
          0 < (a = B(c, "script")).length && Ce(a, !d && B(e, "script")), c
        );
      },
      cleanData: function (e) {
        for (
          var t, n, o, r = C.event.special, i = 0;
          (n = e[i]) !== undefined;
          i++
        )
          if (y(n)) {
      ...
      C.fn.extend({
        ...
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++)
            1 === e.nodeType && (C.cleanData(B(e, !1)), (e.textContent = ""));
          return this;
        },
        clone: function (e, t) {
          return (
      ...
      C.each(
        ...
        function (e, a) {
          C.fn[e] = function (e) {
            for (var t, n = [], o = C(e), r = o.length - 1, i = 0; i <= r; i++)
    ...
    function Qe() {
      ...
      r &&
        ...
        w.appendChild(Ue).appendChild(r),
        (e = T.getComputedStyle(r)),
        (Ie = "1%" !== e.top),
      ...
      return (
        (n = n || Xe(e)) &&
          ...
          !m.pixelBoxStyles() &&
            ...
            (t = i.minWidth),
            (o = i.maxWidth),
            (i.minWidth = i.maxWidth = i.width = r),
            (r = n.width),
            (i.width = e),
            (i.minWidth = t),
            (i.maxWidth = o))),
    ...
    function lt(e, t, n, o, r, i) {
      ...
      for (; a < 4; a += 2)
        "margin" === n && (u += C.css(e, n + p[a], !0, r)),
          o
            ? ("content" === n && (u -= C.css(e, "padding" + p[a], !0, r)),
              "margin" !== n &&
                (u -= C.css(e, "border" + p[a] + "Width", !0, r)))
            : ((u += C.css(e, "padding" + p[a], !0, r)),
              "padding" !== n
                ? (u += C.css(e, "border" + p[a] + "Width", !0, r))
                : (s += C.css(e, "border" + p[a] + "Width", !0, r)));
      return (
        !o &&
          0 <= i &&
          (u +=
    ...
    function ct(e, t, n) {
      ...
      return (
        ((!m.boxSizingReliable() && r) ||
          ...
          "auto" === a ||
          (!parseFloat(a) && "inline" === C.css(e, "display", !1, o))) &&
          e.getClientRects().length &&
          ((r = "border-box" === C.css(e, "boxSizing", !1, o)),
          (i = s in e) && (a = e[s])),
        (a = parseFloat(a) || 0) +
          lt(e, t, n || (r ? "border" : "content"), i, o, a) +
          "px"
      );
    }
      ...
      style: function (e, t, n, o) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ...
            return a && "get" in a && (r = a.get(e, !1, o)) !== undefined
              ? r
              : l[t];
          "string" === (i = typeof n) &&
            (r = ge.exec(n)) &&
      ...
      css: function (e, t, n, o) {
        ...
        return (
          ...
          "normal" ===
            (r =
              (r =
                (i = C.cssHooks[t] || C.cssHooks[i]) && "get" in i
                  ? i.get(e, !0, n)
                  : r) === undefined
                ? Je(e, t, o)
                : r) &&
        ...
        C.cssHooks[a] = {
          ...
          set: function (e, t, n) {
            var o = Xe(e),
              ...
              i = (r || n) && "border-box" === C.css(e, "boxSizing", !1, o),
              n = n ? lt(e, a, n, i, o) : 0;
            return (
              i &&
                r &&
          ...
          (C.cssHooks[r + i] = {
            expand: function (e) {
              for (
                ...
                n[r + p[t] + i] = o[t] || o[t - 2] || o[0];
              return n;
            },
          }),
            "margin" !== r && (C.cssHooks[r + i].set = ut);
        }
      ),
      C.fn.extend({
        css: function (e, t) {
    ...
    function M(r, e, t) {
      var n,
        ...
        f = function () {
          ...
          for (
            ...
            h.tweens[n].run(t);
          return (
            p.notifyWith(r, [h, t, e]),
            t < 1 && o
              ? e
              : (o || p.notifyWith(r, [h, 1, 0]), p.resolveWith(r, [h]), !1)
          );
        },
        h = p.promise({
          elem: r,
          ...
          stop: function (e) {
            ...
            return (
              e
                ? (p.notifyWith(r, [h, 1, 0]), p.resolveWith(r, [h, e]))
                : p.rejectWith(r, [h, e]),
              this
            );
          },
      ...
      for (o in g)
        if (
          ((s = y[(a = b(o))]),
          (u = g[o]),
          Array.isArray(u) && ((s = u[1]), (u = g[o] = u[0])),
          o !== a && ((g[a] = u), delete g[o]),
          (l = C.cssHooks[a]) && "expand" in l)
        )
          for (o in ((u = l.expand(u)), delete g[a], u))
            o in g || ((g[o] = u[o]), (y[o] = s));
        else y[a] = s;
      for (; c < d; c++)
        if ((n = M.prefilters[c].call(h, r, m, h.opts)))
          return (
            v(n.stop) &&
    ...
    (C.Animation = C.extend(M, {
      ...
      tweener: function (e, t) {
        for (
          var n, o = 0, r = (e = v(e) ? ((t = e), ["*"]) : e.match(j)).length;
          o < r;
          o++
        )
          (n = e[o]),
          ...
          t))
            if (((r = t[o]), pt.test(r))) {
              if (
                ...
                if ("show" !== r || !m || m[o] === undefined) continue;
                h = !0;
              }
              p[o] = (m && m[o]) || C.style(e, o);
            }
          if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(p))
            ...
            p))
              u ||
                ...
                h && A([e], !0),
                d.done(function () {
                  for (o in (h || A([e]), x.remove(e, "fxshow"), p))
                    C.style(e, o, p[o]);
                })),
                (u = yt(h ? m[o] : 0, o, d)),
                o in m ||
                  ((m[o] = u.start), h && ((u.end = u.start), (u.start = 0)));
        },
      ],
      ...
      C.fn.extend({
        ...
        animate: function (t, e, n, o) {
          var r = C.isEmptyObject(t),
            i = C.speed(e, n, o),
            e = function () {
              var e = M(this, C.extend({}, t), i);
              (r || x.get(this, "finish")) && e.stop(!0);
            };
          return (
            (e.finish = e),
            r || !1 === i.queue ? this.each(e) : this.queue(i.queue, e)
          );
        },
        stop: function (r, e, i) {
          var a = function (e) {
          ...
          return (
            "string" != typeof r && ((i = e), (e = r), (r = undefined)),
            e && this.queue(r || "fx", []),
            this.each(function () {
              var e = !0,
              ...
              else for (t in o) o[t] && o[t].stop && ft.test(t) && a(o[t]);
              for (t = n.length; t--; )
                n[t].elem !== this ||
                  (null != r && n[t].queue !== r) ||
                  (n[t].anim.stop(i), (e = !1), n.splice(t, 1));
              (!e && i) || C.dequeue(this, r);
            })
          );
        },
        finish: function (a) {
      ...
      (C.fx.tick = function () {
        ...
        n.length || C.fx.stop(), (D = undefined);
      }),
              ...
              return "undefined" == typeof e.getAttribute
                ...
                : ((1 === i && C.isXMLDoc(e)) ||
                    (r =
                      ...
                      (C.expr.match.bool.test(t) ? vt : undefined)),
                  n !== undefined
                    ? null === n
                      ? void C.removeAttr(e, t)
                      : r && "set" in r && (o = r.set(e, n, t)) !== undefined
                      ? o
    ...
    C.fn.extend({
      ...
      C.fn.extend({
        addClass: function (t) {
          ...
          if ((e = Tt(t)).length)
            for (; (n = this[s++]); )
              if (((a = q(n)), (o = 1 === n.nodeType && " " + L(a) + " "))) {
                for (i = 0; (r = e[i++]); )
                  o.indexOf(" " + r + " ") < 0 && (o += r + " ");
                a !== (a = L(o)) && n.setAttribute("class", a);
              }
          return this;
        },
        ...
        toggleClass: function (r, t) {
          ...
          return "boolean" == typeof t && a
            ...
            ? this.each(function (e) {
                C(this).toggleClass(r.call(this, e, q(this), t), t);
              })
            : this.each(function () {
                var e, t, n, o;
                if (a)
                  for (t = 0, n = C(this), o = Tt(r); (e = o[t++]); )
                    n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                else
                  (r !== undefined && "boolean" != i) ||
                    ((e = q(this)) && x.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
        ...
        hasClass: function (e) {
          for (var t, n = 0, o = " " + e + " "; (t = this[n++]); )
            if (1 === t.nodeType && -1 < (" " + L(q(t)) + " ").indexOf(o))
              return !0;
          return !1;
        },
      });
        ...
        C.extend({
          valHooks: {
            ...
            select: {
              ...
              set: function (e, t) {
                for (
                  var n, o, r = e.options, i = C.makeArray(t), a = r.length;
                  a--;

                )
                  ((o = r[a]).selected =
                    -1 < C.inArray(C.valHooks.option.get(o), i)) && (n = !0);
        ...
        (C.extend(C.event, {
          trigger: function (e, t, n, o) {
            ...
            if (
              ...
              ((e = e[C.expando]
                ? e
                : new C.Event(p, "object" == typeof e && e)).isTrigger = o
                ? 2
                : 3),
              (e.namespace = f.join(".")),
              ...
              if (!o && !l.noBubble && !g(n)) {
                for (
                  a = l.delegateType || p, Ct.test(a + p) || (h = h.parentNode);
                  h;
                  h = h.parentNode
                )
                  d.push(h), (i = h);
                i === (n.ownerDocument || k) &&
                  d.push(i.defaultView || i.parentWindow || T);
              }
              for (r = 0; (h = d[r++]) && !e.isPropagationStopped(); )
                (c = h),
                  (e.type = 1 < r ? a : l.bindType || p),
                  (u =
                    (x.get(h, "events") || Object.create(null))[e.type] &&
                    x.get(h, "handle")) && u.apply(h, t),
                  (u = s && h[s]) &&
                    u.apply &&
                    y(h) &&
              ...
              return (
                ...
                o ||
                  ...
                  (s &&
                    ...
                    n[p](),
                    e.isPropagationStopped() && c.removeEventListener(p, jt),
            ...
            function (n, o) {
              ...
              C.event.special[o] = {
                ...
                teardown: function () {
                  ...
                  t
                    ? x.access(e, o, t)
                    : (e.removeEventListener(n, r, !0), x.remove(e, o));
                },
              };
            }
          ),
    ...
    function Ut(e, t) {
      ...
      for (n in t) t[n] !== undefined && ((r[n] ? e : (o = o || {}))[n] = t[n]);
    ...
    (Wt.href = St.href),
      C.extend({
        ...
        ajax: function (e, t) {
          ...
          if (h.beforeSend && (!1 === h.beforeSend.call(m, x, h) || p))
            return x.abort();
          if (
            ((a = "abort"),
            v.add(h.complete),
            ...
            if (((x.readyState = 1), f && g.trigger("ajaxSend", [x, h]), p))
              return x;
            h["async"] &&
              0 < h.timeout &&
          ...
          function s(e, t, n, o) {
            ...
            p ||
              ...
              n &&
                (a = (function (e, t, n) {
                  for (
                    var o, r, i, a, s = e.contents, u = e.dataTypes;
                    "*" === u[0];
              ...
              o
                ? (h.ifModified &&
                  ...
                  204 === e || "HEAD" === h.type
                    ...
                    : 304 === e
                    ? (s = "notmodified")
                    : ((s = a.state), (r = a.data), (o = !(i = a.error))))
                : ((i = s), (!e && s) || ((s = "error"), e < 0 && (e = 0))),
              (x.status = e),
              (x.statusText = (t || s) + ""),
              o ? y.resolveWith(m, [r, s, x]) : y.rejectWith(m, [x, s, i]),
              x.statusCode(b),
              (b = undefined),
              f &&
                g.trigger(o ? "ajaxSuccess" : "ajaxError", [x, h, o ? r : i]),
              v.fireWith(m, [x, s]),
              f &&
            ...
            return {
              send: function (e, t) {
                ...
                (a = function (e) {
                  ...
                  (o.onload = a()),
                  (s = o.onerror = o.ontimeout = a("error")),
                  o.onabort !== undefined
                    ? (o.onabort = s)
      ...
      Yt =
        (C.ajaxSetup({
          ...
          jsonpCallback: function () {
            var e = Kt.pop() || C.expando + "_" + At.guid++;
            return (this[e] = !0), e;
          },
        }),
        C.ajaxPrefilter("json jsonp", function (e, t, n) {
          ...
          if (a || "jsonp" === e.dataTypes[0])
            return (
              ...
              n.always(function () {
                r === undefined ? C(T).removeProp(o) : (T[o] = r),
        ...
        (C.fn.load = function (e, t, n) {
          var o,
            ...
            s = e.indexOf(" ");
          return (
            -1 < s && ((o = L(e.slice(s))), (e = e.slice(0, s))),
            v(t)
              ? ((n = t), (t = undefined))
          ...
          setOffset: function (e, t, n) {
            ...
            "static" === s && (e.style.position = "relative"),
              ...
              (s =
                ("absolute" === s || "fixed" === s) &&
                -1 < (o + a).indexOf("auto")
                  ? ((r = (s = u.position()).top), s.left)
                  : ((r = parseFloat(o) || 0), parseFloat(a) || 0)),
              null != (t = v(t) ? t.call(e, n, C.extend({}, i)) : t).top &&
                (l.top = t.top - i.top + r),
    ...
    return (
      (C.noConflict = function (e) {
        return (
          T.$ === C && (T.$ = Zt), e && T.jQuery === C && (T.jQuery = Jt), C
        );
      }),
      void 0 === F && (T.jQuery = T.$ = C),
      C
    );
  });
  var s = jQuery.noConflict(!0),
    u = {
      removeAttributeValue: function (e, t, n) {
        var o;
        e.getAttribute(t) &&
          (e.getAttribute(t) == n
            ? e.removeAttribute(t)
            : ((n = new RegExp("(^|\\s)" + n + "(\\s|$)")),
              (o = e.getAttribute(t).match(n)) &&
                3 == o.length &&
                e.setAttribute(
                  t,
                  e.getAttribute(t).replace(n, o[1] && o[2] ? " " : "")
                )));
      },
      addAttributeValue: function (e, t, n) {
        e.getAttribute(t)
          ? new RegExp("(^|\\s)" + n + "(\\s|$)").test(e.getAttribute(t)) ||
            e.setAttribute(t, e.getAttribute(t) + " " + n)
          : e.setAttribute(t, n);
      },
      dragAndDropSupported: function () {
        return "undefined" != typeof document.createElement("div").ondrop;
      },
      ...
      fileApiSupported: function () {
        ...
        return (e.type = "file"), "undefined" != typeof e.files;
      },
      nodeListForEach: function (e, t) {
        if (window.NodeList.prototype.forEach) return e.forEach(t);
        for (var n = 0; n < e.length; n++) t.call(window, e[n], n, e);
      },
      initAll: function (e) {
        var e =
            "undefined" != typeof (e = void 0 !== e ? e : {}).scope
              ? e.scope
              : document,
          t = e.querySelectorAll('[data-module="moj-add-another"]'),
          t =
            (u.nodeListForEach(t, function (e) {
              new u.AddAnother(e);
            }),
            e.querySelectorAll('[data-module="moj-multi-select"]')),
          t =
            (u.nodeListForEach(t, function (e) {
              new u.MultiSelect({
                container: e.querySelector(
                  e.getAttribute("data-multi-select-checkbox")
                ),
            ...
            e.querySelectorAll('[data-module="moj-password-reveal"]')),
          t =
            (u.nodeListForEach(t, function (e) {
              new u.PasswordReveal(e);
            }),
            e.querySelectorAll('[data-module="moj-rich-text-editor"]')),
          t =
            (u.nodeListForEach(t, function (e) {
              var t = {
                  textarea: s(e),
                },
                e = e.getAttribute("data-moj-rich-text-editor-toolbar");
              if (e) {
                var n,
                  o = e.split(",");
                for (n in ((t.toolbar = {}), o)) t.toolbar[o[n]] = !0;
              }
              new u.RichTextEditor(t);
            }),
            e.querySelectorAll('[data-module="moj-search-toggle"]')),
          t =
            (u.nodeListForEach(t, function (e) {
              new u.SearchToggle({
                toggleButton: {
                  container: s(e.querySelector(".moj-search-toggle__toggle")),
                  text: e.getAttribute("data-moj-search-toggle-text"),
                },
                search: {
                  container: s(e.querySelector(".moj-search")),
                },
              });
            }),
            e.querySelectorAll('[data-module="moj-sortable-table"]')),
          t =
            (u.nodeListForEach(t, function (e) {
              new u.SortableTable({
                table: e,
        ...
        (this.container = s(e)),
          this.container.data("moj-add-another-initialised") ||
            ...
            this.container.on(
              ...
              s.proxy(this, "onRemoveButtonClick")
            ),
            this.container.on(
              "click",
              ".moj-add-another__add-button",
              s.proxy(this, "onAddButtonClick")
            ),
            this.container
              .find(
  ...
  return (
    (u.AddAnother.prototype.onAddButtonClick = function (e) {
      var t = this.getNewItem(),
        n =
          (this.updateAttributes(this.getItems().length, t),
          this.resetItem(t),
          this.getItems().first());
      this.hasRemoveButton(n) || this.createRemoveButton(n),
        this.getItems().last().after(t),
        t.find("input, textarea, select").first().focus();
    }),
    (u.AddAnother.prototype.hasRemoveButton = function (e) {
      return e.find(".moj-add-another__remove-button").length;
    }),
    (u.AddAnother.prototype.getItems = function () {
      return this.container.find(".moj-add-another__item");
    }),
    (u.AddAnother.prototype.getNewItem = function () {
      var e = this.getItems().first().clone();
      return this.hasRemoveButton(e) || this.createRemoveButton(e), e;
    }),
    (u.AddAnother.prototype.updateAttributes = function (o, r) {
      r.find("[data-name]").each(function (e, t) {
        var n = t.id;
        (t.name = s(t)
          .attr("data-name")
          .replace(/%index%/, o)),
          (t.id = s(t)
            ...
            .replace(/%index%/, o)),
          ((
            s(t).siblings("label")[0] ||
            s(t).parents("label")[0] ||
            r.find('[for="' + n + '"]')[0]
          ).htmlFor = t.id);
      });
    }),
    (u.AddAnother.prototype.createRemoveButton = function (e) {
      e.append(
        '<button type="button" class="govuk-button govuk-button--secondary moj-add-another__remove-button">Remove</button>'
      );
    }),
    (u.AddAnother.prototype.resetItem = function (e) {
      e.find("[data-name], [data-id]").each(function (e, t) {
        "checkbox" == t.type || "radio" == t.type
          ? (t.checked = !1)
          : (t.value = "");
      });
    }),
    (u.AddAnother.prototype.onRemoveButtonClick = function (e) {
      s(e.currentTarget).parents(".moj-add-another__item").remove();
      e = this.getItems();
      1 === e.length && e.find(".moj-add-another__remove-button").remove(),
        e.each(
          s.proxy(function (e, t) {
            this.updateAttributes(e, s(t));
          }, this)
        ),
        this.focusHeading();
    }),
    (u.AddAnother.prototype.focusHeading = function () {
      this.container.find(".moj-add-another__heading").focus();
    }),
    (u.ButtonMenu = function (e) {
      (this.container = e.container),
        (this.menu = this.container.find(".moj-button-menu__wrapper")),
        e.menuClasses && this.menu.addClass(e.menuClasses),
        this.menu.attr("role", "menu"),
        (this.mq = e.mq),
        (this.buttonText = e.buttonText),
        ...
        this.menu.on(
          "keydown",
          "[role=menuitem]",
          s.proxy(this, "onButtonKeydown")
        ),
        this.createToggleButton(),
        this.setupResponsiveChecks(),
        s(document).on("click", s.proxy(this, "onDocumentClick"));
    }),
    (u.ButtonMenu.prototype.onDocumentClick = function (e) {
      s.contains(this.container[0], e.target) || this.hideMenu();
    }),
    (u.ButtonMenu.prototype.createToggleButton = function () {
      (this.menuButton = s(
        ...
        this.menuButton.on("click", s.proxy(this, "onMenuButtonClick")),
        this.menuButton.on("keydown", s.proxy(this, "onMenuKeyDown"));
    }),
    (u.ButtonMenu.prototype.setupResponsiveChecks = function () {
      (this.mql = window.matchMedia(this.mq)),
        this.mql.addListener(s.proxy(this, "checkMode")),
        this.checkMode(this.mql);
    }),
    (u.ButtonMenu.prototype.checkMode = function (e) {
      e.matches ? this.enableBigMode() : this.enableSmallMode();
    }),
    (u.ButtonMenu.prototype.enableSmallMode = function () {
    ...
    (u.ButtonMenu.prototype.enableBigMode = function () {
    ...
    (u.ButtonMenu.prototype.removeButtonClasses = function () {
      this.menu.find(".moj-button-menu__item").each(function (e, t) {
        s(t).hasClass("govuk-button--secondary") &&
          (s(t).attr("data-secondary", "true"),
          s(t).removeClass("govuk-button--secondary")),
          s(t).hasClass("govuk-button--warning") &&
            (s(t).attr("data-warning", "true"),
            s(t).removeClass("govuk-button--warning")),
          s(t).removeClass("govuk-button");
      });
    }),
    (u.ButtonMenu.prototype.addButtonClasses = function () {
      this.menu.find(".moj-button-menu__item").each(function (e, t) {
        "true" == s(t).attr("data-secondary") &&
          s(t).addClass("govuk-button--secondary"),
          "true" == s(t).attr("data-warning") &&
            s(t).addClass("govuk-button--warning"),
          s(t).addClass("govuk-button");
      });
    }),
    (u.ButtonMenu.prototype.hideMenu = function () {
      this.menuButton.attr("aria-expanded", "false");
    }),
    (u.ButtonMenu.prototype.showMenu = function () {
      this.menuButton.attr("aria-expanded", "true");
    }),
    (u.ButtonMenu.prototype.onMenuButtonClick = function () {
      this.toggle();
    }),
    (u.ButtonMenu.prototype.toggle = function () {
    ...
    (u.ButtonMenu.prototype.onMenuKeyDown = function (e) {
      e.keyCode === this.keys.down && this.toggle();
    }),
    (u.ButtonMenu.prototype.onButtonKeydown = function (e) {
      switch (e.keyCode) {
        case this.keys.up:
          e.preventDefault(), this.focusPrevious(e.currentTarget);
          break;
        case this.keys.down:
          e.preventDefault(), this.focusNext(e.currentTarget);
          break;
        case this.keys.esc:
    ...
    (u.ButtonMenu.prototype.focusNext = function (e) {
      e = s(e).next();
      (e[0] ? e : this.container.find("[role=menuitem]").first()).focus();
    }),
    (u.ButtonMenu.prototype.focusPrevious = function (e) {
      e = s(e).prev();
      (e[0] ? e : this.container.find("[role=menuitem]").last()).focus();
    }),
    (u.FilterToggleButton = function (e) {
      (this.options = e),
    ...
    (u.FilterToggleButton.prototype.setupResponsiveChecks = function () {
      (this.mq = window.matchMedia(this.options.bigModeMediaQuery)),
        this.mq.addListener(s.proxy(this, "checkMode")),
        this.checkMode(this.mq);
    }),
    (u.FilterToggleButton.prototype.createToggleButton = function () {
      (this.menuButton = s(
    ...
    (u.FilterToggleButton.prototype.checkMode = function (e) {
      e.matches ? this.enableBigMode() : this.enableSmallMode();
    }),
    (u.FilterToggleButton.prototype.enableBigMode = function () {
      this.showMenu(), this.removeCloseButton();
    }),
    (u.FilterToggleButton.prototype.enableSmallMode = function () {
      this.hideMenu(), this.addCloseButton();
    }),
    (u.FilterToggleButton.prototype.addCloseButton = function () {
      this.options.closeButton &&
        ...
        this.closeButton.on("click", s.proxy(this, "onCloseClick")),
        this.options.closeButton.container.append(this.closeButton));
    }),
    (u.FilterToggleButton.prototype.onCloseClick = function () {
      this.hideMenu(), this.menuButton.focus();
    }),
    (u.FilterToggleButton.prototype.removeCloseButton = function () {
      this.closeButton &&
        (this.closeButton.remove(), (this.closeButton = null));
    }),
    (u.FilterToggleButton.prototype.hideMenu = function () {
      this.menuButton.attr("aria-expanded", "false"),
        this.options.filter.container.addClass("moj-js-hidden"),
        this.menuButton.text(this.options.toggleButton.showText);
    }),
    (u.FilterToggleButton.prototype.showMenu = function () {
      this.menuButton.attr("aria-expanded", "true"),
        this.options.filter.container.removeClass("moj-js-hidden"),
        this.menuButton.text(this.options.toggleButton.hideText);
    }),
    (u.FilterToggleButton.prototype.onMenuButtonClick = function () {
      this.toggle();
    }),
    (u.FilterToggleButton.prototype.toggle = function () {
      "false" == this.menuButton.attr("aria-expanded")
        ? (this.showMenu(), this.options.filter.container.focus())
        : this.hideMenu();
    }),
    (u.FormValidator = function (e, t) {
      (this.form = e),
        (this.errors = []),
        (this.validators = []),
        s(this.form).on("submit", s.proxy(this, "onSubmit")),
        (this.summary =
          t && t.summary ? s(t.summary) : s(".govuk-error-summary")),
        (this.originalTitle = document.title);
    }),
    (u.FormValidator.entityMap = {
      "&": "&amp;",
      "<": "&lt;",
      ">": "&gt;",
      '"': "&quot;",
    ...
    (u.FormValidator.prototype.escapeHtml = function (e) {
      return String(e).replace(/[&<>"'`=\/]/g, function (e) {
        return u.FormValidator.entityMap[e];
      });
    }),
    (u.FormValidator.prototype.resetTitle = function () {
      document.title = this.originalTitle;
    }),
    (u.FormValidator.prototype.updateTitle = function () {
      document.title = this.errors.length + " errors - " + document.title;
    }),
    (u.FormValidator.prototype.showSummary = function () {
    ...
    (u.FormValidator.prototype.getSummaryHtml = function () {
      o =
        '<h2 id="error-summary-title" class="govuk-error-summary__title">There is a problem</h2><div class="govuk-error-summary__body"><ul class="govuk-list govuk-error-summary__list">';
      for (var e = 0, t = this.errors.length; e < t; e++)
        var n = this.errors[e],
          o =
            (o =
              (o =
                (o += "<li>") +
                ('<a href="#' + this.escapeHtml(n.fieldName) + '">')) +
              this.escapeHtml(n.message)) +
            "</a>" +
            "</li>";
      return (o = o + "</ul>" + "</div>");
    }),
    (u.FormValidator.prototype.hideSummary = function () {
      this.summary.addClass("moj-hidden"),
        this.summary.removeAttr("aria-labelledby");
    }),
    (u.FormValidator.prototype.onSubmit = function (e) {
    ...
    (u.FormValidator.prototype.showInlineErrors = function () {
      for (var e = 0, t = this.errors.length; e < t; e++)
        this.showInlineError(this.errors[e]);
    }),
    (u.FormValidator.prototype.showInlineError = function (e) {
      var t = e.fieldName + "-error",
        n =
          '<span class="govuk-error-message" id="' +
          t +
          '">' +
          this.escapeHtml(e.message) +
          "</span>",
        e = s("#" + e.fieldName),
        o = e.parents(".govuk-form-group"),
        r = o.find("label"),
        i = o.find("legend"),
        a = o.find("fieldset");
      o.addClass("govuk-form-group--error"),
        i.length
          ? (i.after(n),
            o.attr("aria-invalid", "true"),
            u.addAttributeValue(a[0], "aria-describedby", t))
          : (r.after(n),
            e.attr("aria-invalid", "true"),
            u.addAttributeValue(e[0], "aria-describedby", t));
    }),
    (u.FormValidator.prototype.removeInlineErrors = function () {
      for (var e = 0; e < this.errors.length; e++)
        this.removeInlineError(this.errors[e]);
    }),
    (u.FormValidator.prototype.removeInlineError = function (e) {
      var t = s("#" + e.fieldName).parents(".govuk-form-group"),
        e =
          (t.find(".govuk-error-message").remove(),
          t.removeClass("govuk-form-group--error"),
          t.find("[aria-invalid]").attr("aria-invalid", "false"),
          e.fieldName + "-error");
      u.removeAttributeValue(
        t.find("[aria-describedby]")[0],
        "aria-describedby",
        e
      );
    }),
    (u.FormValidator.prototype.addValidator = function (e, t) {
      this.validators.push({
        fieldName: e,
        rules: t,
        field: this.form.elements[e],
      });
    }),
    (u.FormValidator.prototype.validate = function () {
      this.errors = [];
      for (var e, t, n = null, o = 0; o < this.validators.length; o++)
        for (n = this.validators[o], t = 0; t < n.rules.length; t++) {
          if (
            "boolean" ==
              typeof (e = n.rules[t].method(n.field, n.rules[t].params)) &&
            !e
          ) {
            this.errors.push({
              fieldName: n.fieldName,
              message: n.rules[t].message,
            });
            break;
          }
          if ("string" == typeof e) {
    ...
    u.dragAndDropSupported() &&
      u.formDataSupported() &&
      u.fileApiSupported() &&
      ((u.MultiFileUpload = function (e) {
        (this.defaultParams = {
          uploadFileEntryHook: s.noop,
          uploadFileExitHook: s.noop,
          uploadFileErrorHook: s.noop,
          fileDeleteHook: s.noop,
          uploadStatusText: "Uploading files, please wait",
          dropzoneHintText: "Drag and drop files here or",
          dropzoneButtonText: "Choose files",
        }),
          (this.params = s.extend({}, this.defaultParams, e)),
          this.params.container.addClass("moj-multi-file-upload--enhanced"),
          (this.feedbackContainer = this.params.container.find(
          ...
          this.params.container.on(
            ...
            s.proxy(this, "onFileDeleteClick")
          );
      }),
      (u.MultiFileUpload.prototype.setupDropzone = function () {
        this.fileInput.wrap('<div class="moj-multi-file-upload__dropzone" />'),
          (this.dropzone = this.params.container.find(
            ".moj-multi-file-upload__dropzone"
          )),
          this.dropzone.on("dragover", s.proxy(this, "onDragOver")),
          this.dropzone.on("dragleave", s.proxy(this, "onDragLeave")),
          this.dropzone.on("drop", s.proxy(this, "onDrop"));
      }),
      (u.MultiFileUpload.prototype.setupLabel = function () {
        (this.label = s(
          '<label for="' +
            this.fileInput[0].id +
      ...
      (u.MultiFileUpload.prototype.setupFileInput = function () {
        (this.fileInput = this.params.container.find(
          ".moj-multi-file-upload__input"
        )),
          this.fileInput.on("change", s.proxy(this, "onFileChange")),
          this.fileInput.on("focus", s.proxy(this, "onFileFocus")),
          this.fileInput.on("blur", s.proxy(this, "onFileBlur"));
      }),
      (u.MultiFileUpload.prototype.setupStatusBox = function () {
        (this.status = s(
          '<div aria-live="polite" role="status" class="govuk-visually-hidden" />'
        )),
          this.dropzone.append(this.status);
      }),
      (u.MultiFileUpload.prototype.onDragOver = function (e) {
        e.preventDefault(),
          this.dropzone.addClass("moj-multi-file-upload--dragover");
      }),
      (u.MultiFileUpload.prototype.onDragLeave = function () {
        this.dropzone.removeClass("moj-multi-file-upload--dragover");
      }),
      (u.MultiFileUpload.prototype.onDrop = function (e) {
        e.preventDefault(),
          this.dropzone.removeClass("moj-multi-file-upload--dragover"),
      ...
      (u.MultiFileUpload.prototype.uploadFiles = function (e) {
        for (var t = 0; t < e.length; t++) this.uploadFile(e[t]);
      }),
      (u.MultiFileUpload.prototype.onFileChange = function (e) {
        this.feedbackContainer.removeClass("moj-hidden"),
          this.status.html(this.params.uploadStatusText),
          this.uploadFiles(e.currentTarget.files),
          this.fileInput.replaceWith(s(e.currentTarget).val("").clone(!0)),
          this.setupFileInput(),
          this.fileInput.focus();
      }),
      (u.MultiFileUpload.prototype.onFileFocus = function (e) {
        this.label.addClass("moj-multi-file-upload--focused");
      }),
      (u.MultiFileUpload.prototype.onFileBlur = function (e) {
        this.label.removeClass("moj-multi-file-upload--focused");
      }),
      (u.MultiFileUpload.prototype.getSuccessHtml = function (e) {
        return (
      ...
      (u.MultiFileUpload.prototype.getErrorHtml = function (e) {
        return (
      ...
      (u.MultiFileUpload.prototype.getFileRowHtml = function (e) {
        var t = "";
        return (
          (t +=
      ...
      (u.MultiFileUpload.prototype.getDeleteButtonHtml = function (e) {
        var t =
      ...
      (u.MultiFileUpload.prototype.uploadFile = function (o) {
        this.params.uploadFileEntryHook(this, o);
        var e = new FormData(),
          t = (e.append("documents", o), s(this.getFileRowHtml(o)));
        this.feedbackContainer.find(".moj-multi-file-upload__list").append(t),
          s.ajax({
            ...
            processData: !1,
            contentType: !1,
            success: s.proxy(function (e) {
              e.error
                ? (t
                    .find(".moj-multi-file-upload__message")
                    .html(this.getErrorHtml(e.error)),
                  this.status.html(e.error.message))
                : (t
                    .find(".moj-multi-file-upload__message")
                    .html(this.getSuccessHtml(e.success)),
                  this.status.html(e.success.messageText)),
                t
                  .find(".moj-multi-file-upload__actions")
                  .append(this.getDeleteButtonHtml(e.file)),
                this.params.uploadFileExitHook(this, o, e);
            }, this),
            error: s.proxy(function (e, t, n) {
              this.params.uploadFileErrorHook(this, o, e, t, n);
            }, this),
            xhr: function () {
      ...
      (u.MultiFileUpload.prototype.onFileDeleteClick = function (e) {
        e.preventDefault();
        var t = s(e.currentTarget),
          e = {};
        (e[t[0].name] = t[0].value),
          s.ajax({
            ...
            success: s.proxy(function (e) {
              e.error ||
                (t.parents(".moj-multi-file-upload__row").remove(),
                0 ===
                  this.feedbackContainer.find(".moj-multi-file-upload__row")
                    .length && this.feedbackContainer.addClass("moj-hidden")),
                this.params.fileDeleteHook(this, e);
            }, this),
          });
      })),
    (u.MultiSelect = function (e) {
      (this.container = s(e.container)),
        this.container.data("moj-multi-select-initialised") ||
          (this.container.data("moj-multi-select-initialised", !0),
          (this.toggle = s(this.getToggleHtml())),
          (this.toggleButton = this.toggle.find("input")),
          this.toggleButton.on("click", s.proxy(this, "onButtonClick")),
          this.container.append(this.toggle),
          (this.checkboxes = s(e.checkboxes)),
          this.checkboxes.on("click", s.proxy(this, "onCheckboxClick")),
          (this.checked = e.checked || !1));
    }),
    (u.MultiSelect.prototype.getToggleHtml = function () {
      return '<div class="govuk-checkboxes__item govuk-checkboxes--small moj-multi-select__checkbox">  <input type="checkbox" class="govuk-checkboxes__input" id="checkboxes-all">  <label class="govuk-label govuk-checkboxes__label moj-multi-select__toggle-label" for="checkboxes-all">    <span class="govuk-visually-hidden">Select all</span>  </label></div>';
    }),
    (u.MultiSelect.prototype.onButtonClick = function (e) {
      this.checked
        ? (this.uncheckAll(), (this.toggleButton[0].checked = !1))
        : (this.checkAll(), (this.toggleButton[0].checked = !0));
    }),
    (u.MultiSelect.prototype.checkAll = function () {
    ...
    (u.MultiSelect.prototype.uncheckAll = function () {
      this.checkboxes.each(
        s.proxy(function (e, t) {
          t.checked = !1;
        }, this)
    ...
    (u.MultiSelect.prototype.onCheckboxClick = function (e) {
      e.target.checked
        ? this.checkboxes.filter(":checked").length ===
            this.checkboxes.length &&
          ((this.toggleButton[0].checked = !0), (this.checked = !0))
        : ((this.toggleButton[0].checked = !1), (this.checked = !1));
    }),
    (u.PasswordReveal = function (e) {
      (this.el = e),
        ($el = s(this.el)).data("moj-password-reveal-initialised") ||
          ($el.data("moj-password-reveal-initialised", !0),
          $el.attr("spellcheck", "false"),
          $el.wrap('<div class="moj-password-reveal"></div>'),
          (this.container = s(this.el).parent()),
          this.createButton());
    }),
    (u.PasswordReveal.prototype.createButton = function () {
      (this.button = s(
        ...
        this.button.on("click", s.proxy(this, "onButtonClick"));
    }),
    (u.PasswordReveal.prototype.onButtonClick = function () {
    ...
    "contentEditable" in document.documentElement &&
      ((u.RichTextEditor = function (e) {
        (this.options = e),
          ...
          (this.container = s(this.textarea).parent()),
          this.container.data("moj-rich-text-editor-initialised") ||
            ...
            this.container.on(
              ...
              s.proxy(this, "onButtonClick")
            ),
            this.container
              .find(".moj-rich-text-editor__content")
              .on("input", s.proxy(this, "onEditorInput")),
            this.container
              .find("label")
              .on("click", s.proxy(this, "onLabelClick")),
            this.toolbar.on("keydown", s.proxy(this, "onToolbarKeydown")));
      }),
      (u.RichTextEditor.prototype.onToolbarKeydown = function (e) {
        switch (e.keyCode) {
          case this.keys.right:
          case this.keys.down:
            var t,
              n = (t = this.toolbar.find("button[tabindex=0]")).next("button");
            n[0] &&
              (n.focus(), t.attr("tabindex", "-1"), n.attr("tabindex", "0"));
            break;
          case this.keys.left:
          case this.keys.up:
            n = (t = this.toolbar.find("button[tabindex=0]")).prev("button");
            n[0] &&
              (n.focus(), t.attr("tabindex", "-1"), n.attr("tabindex", "0"));
        }
      }),
      (u.RichTextEditor.prototype.getToolbarHtml = function () {
        var e = "";
        return (
          (e += '<div class="moj-rich-text-editor__toolbar" role="toolbar">'),
      ...
      (u.RichTextEditor.prototype.configureToolbar = function () {
      ...
      (u.RichTextEditor.prototype.onButtonClick = function (e) {
        document.execCommand(s(e.currentTarget).data("command"), !1, null);
      }),
      (u.RichTextEditor.prototype.getContent = function () {
        return this.container.find(".moj-rich-text-editor__content").html();
      }),
      (u.RichTextEditor.prototype.onEditorInput = function (e) {
        this.updateTextarea();
      }),
      (u.RichTextEditor.prototype.updateTextarea = function () {
        document.execCommand("defaultParagraphSeparator", !1, "p"),
          this.textarea.val(this.getContent());
      }),
      (u.RichTextEditor.prototype.onLabelClick = function (e) {
        e.preventDefault(),
          this.container.find(".moj-rich-text-editor__content").focus();
      })),
    (u.SearchToggle = function (e) {
      (this.options = e),
        this.options.search.container.data("moj-search-toggle-initialised") ||
          (this.options.search.container.data(
            "moj-search-toggle-initialised",
            !0
          ),
          (this.toggleButton = s(
          ...
          this.toggleButton.on("click", s.proxy(this, "onToggleButtonClick")),
          this.options.toggleButton.container.append(this.toggleButton));
    }),
    (u.SearchToggle.prototype.onToggleButtonClick = function () {
    ...
    (u.SortableTable = function (e) {
      (this.table = s(e.table)),
        this.table.data("moj-search-toggle-initialised") ||
          ...
          this.table.on(
            "click",
            "th button",
            s.proxy(this, "onSortButtonClick")
          ));
    }),
    (u.SortableTable.prototype.setupOptions = function (e) {
      (this.statusMessage =
        (e = e || {}).statusMessage || "Sort by %heading% (%direction%)"),
        (this.ascendingText = e.ascendingText || "ascending"),
        (this.descendingText = e.descendingText || "descending");
    }),
    (u.SortableTable.prototype.createHeadingButtons = function () {
      for (var e, t = this.table.find("thead th"), n = 0; n < t.length; n++)
        (e = s(t[n])).attr("aria-sort") && this.createHeadingButton(e, n);
    }),
    (u.SortableTable.prototype.createHeadingButton = function (e, t) {
      var n = e.text(),
        t = s(
          '<button type="button" data-index="' + t + '">' + n + "</button>"
        );
      e.text(""), e.append(t);
    }),
    (u.SortableTable.prototype.createStatusBox = function () {
      (this.status = s(
        '<div aria-live="polite" role="status" aria-atomic="true" class="govuk-visually-hidden" />'
      )),
        this.table.parent().append(this.status);
    }),
    (u.SortableTable.prototype.initialiseSortedColumn = function () {
      var o = this.getTableRowsArray();
      this.table
        .find("th")
        .filter('[aria-sort="ascending"], [aria-sort="descending"]')
        .first()
        .each((e, t) => {
          var n = s(t).attr("aria-sort"),
            t = s(t).find("button").attr("data-index"),
            t = this.sort(o, t, n);
          this.addRows(t);
        });
    }),
    (u.SortableTable.prototype.onSortButtonClick = function (e) {
      var t = e.currentTarget.getAttribute("data-index"),
        n = s(e.currentTarget).parent().attr("aria-sort"),
        n = "none" === n || "descending" === n ? "ascending" : "descending",
        o = this.getTableRowsArray(),
        o = this.sort(o, t, n);
      this.addRows(o),
        this.removeButtonStates(),
        this.updateButtonState(s(e.currentTarget), n);
    }),
    (u.SortableTable.prototype.updateButtonState = function (e, t) {
      e.parent().attr("aria-sort", t);
      var n = this.statusMessage;
      (n = (n = n.replace(/%heading%/, e.text())).replace(
        /%direction%/,
        this[t + "Text"]
      )),
        this.status.text(n);
    }),
    (u.SortableTable.prototype.removeButtonStates = function () {
      this.table.find("thead th").attr("aria-sort", "none");
    }),
    (u.SortableTable.prototype.addRows = function (e) {
      for (var t = 0; t < e.length; t++) this.body.append(e[t]);
    }),
    (u.SortableTable.prototype.getTableRowsArray = function () {
      for (var e = [], t = this.body.find("tr"), n = 0; n < t.length; n++)
        e.push(t[n]);
      return e;
    }),
    (u.SortableTable.prototype.sort = function (e, n, o) {
      return e.sort(
        s.proxy(function (e, t) {
          (e = s(e).find("td,th").eq(n)),
            (t = s(t).find("td,th").eq(n)),
            (e = this.getCellValue(e)),
            (t = this.getCellValue(t));
          return "ascending" === o
            ? e < t
              ? -1
              : t < e
    ...
    (u.SortableTable.prototype.getCellValue = function (e) {
      var t = (t = e.attr("data-sort-value")) || e.html();
      return (t = s.isNumeric(t) ? parseInt(t, 10) : t);
    }),
    u
  );
});
